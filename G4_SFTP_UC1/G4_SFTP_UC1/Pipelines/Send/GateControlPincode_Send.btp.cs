namespace G4_SFTP_UC1.Pipelines.Send
{
    ...
    public sealed class GateControlPincode_Send : Microsoft.BizTalk.PipelineOM.SendPipeline
    {
...
"pe=\"xsd:string\">G4_SFTP_UC1.Schemas.PincodeUID_FF_schema</Value>            </Property>            <"+
...
"rty Name=\"HiddenProperties\">              <Value xsi:type=\"xsd:string\">TargetCodePage</Value>       "+
"     </Property>          </Properties>          <CachedDisplayName>Flat file assembler</CachedDispl"+
"ayName>          <CachedIsManaged>true</CachedIsManaged>        </Component>      </Components>    <"+
"/Stage>    <Stage>      <PolicyFileStage _locAttrData=\"Name\" _locID=\"3\" Name=\"Encode\" minOccurs=\"0\" "+
"maxOccurs=\"-1\" execMethod=\"All\" stageId=\"9d0e4108-4cce-4536-83fa-4a5040674ad6\" />      <Components /"+
">    </Stage>  </Stages></Document>";
        
        private const string _versionDependentGuid = "f147d0dc-b280-4355-82a1-970e319a03af";
        
        public GateControlPincode_Send()
        {
...
" />    <Property Name=\"DocumentSpecName\">      <Value xsi:type=\"xsd:string\">G4_SFTP_UC1.Schemas.Pinc"+
"odeUID_FF_schema</Value>    </Property>    <Property Name=\"TrailerSpecName\" />    <Property Name=\"Ta"+
"rgetCharset\">      <Value xsi:type=\"xsd:string\" />    </Property>    <Property Name=\"TargetCodePage\""+
">      <Value xsi:type=\"xsd:int\">0</Value>    </Property>    <Property Name=\"PreserveBom\">      <Val"+
"ue xsi:type=\"xsd:boolean\">false</Value>    </Property>    <Property Name=\"HiddenProperties\">      <V"+
"alue xsi:type=\"xsd:string\">TargetCodePage</Value>    </Property>  </Properties></PropertyBag>";
