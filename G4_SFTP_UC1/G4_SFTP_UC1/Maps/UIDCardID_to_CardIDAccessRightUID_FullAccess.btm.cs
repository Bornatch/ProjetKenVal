namespace G4_SFTP_UC1.Maps {
    ...
    public sealed class UIDCardID_to_CardIDAccessRightUID_Copy : global::Microsoft.XLANGs.BaseTypes.TransformBase {
  ...
  <xsl:template match=""/s0:Root"">
    <ns0:Root>
      <AccessRight>
        ...
        <xsl:variable name=""var:v1"" select=""userCSharp:MyFantasticDoor(&quot;group3&quot;)"" />
        <AccessRight>
